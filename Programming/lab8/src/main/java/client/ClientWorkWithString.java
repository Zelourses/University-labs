...
public class ClientWorkWithString {
    ...
    public static ByteArrayOutputStream createRequest(String command, Object data, String authority) throws IOException {
        SerializeTo c = new SerializeTo(command, data, authority);

         if (command.equals("import")) {
            c.setData(WorkWithFiles.generate((String) data));
            if (c.getData() == null) {
                return null;
            }
        }
